...
public class AppInjector {
  ...
  public static void init(TransporterApplication transporterApplication) {
    DaggerAppComponent.builder().application(transporterApplication)
        .build().inject(transporterApplication);
